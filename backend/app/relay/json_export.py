...
from .utils import bounded_optional, bounded_text, decimal_json_value, iso_z, mode_label
...
def build_review_export(frozen: FrozenSnapshot, generated_at: datetime) -> dict[str, Any]:
    ...
    return {
        "schema_version": "crazymonkey-review-export-v1",
        "export_metadata": {
            "run_id": snapshot.run_id,
        ...
        "findings": [
            {
                ...
                "administrator_value": decimal_json_value(finding.administrator_value),
                "expected_value": decimal_json_value(finding.expected_value),
                "difference": decimal_json_value(finding.difference),
        ...
        "investor_terms": [
            {
                ...
                "term": term.term,
                "default_rate_fraction": decimal_json_value(term.default_rate_fraction),
                "override_rate_fraction": decimal_json_value(term.override_rate_fraction),
                "applicable_rate_fraction": decimal_json_value(term.applicable_rate_fraction),
                "effective_from": term.effective_from,
                "effective_to": term.effective_to,
                "fee_base": decimal_json_value(term.fee_base),
        ...
        "calculations": [
            {
                ...
                "fee_base": decimal_json_value(calculation.fee_base),
                "annual_rate_fraction": decimal_json_value(calculation.annual_rate_fraction),
                "period_factor": decimal_json_value(calculation.period_factor),
                "expected_value": decimal_json_value(calculation.expected_value),
                "reported_value": decimal_json_value(calculation.reported_value),
                "difference": decimal_json_value(calculation.difference),
