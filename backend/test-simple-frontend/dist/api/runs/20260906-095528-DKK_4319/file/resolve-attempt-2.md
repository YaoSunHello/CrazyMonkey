...
Table account_map, Col Bank Account: 5 matches
   NI ABF II - Calder - DKK - 4319
   NI ABF II - Calder - EUR - 8102
   NIP V - Calder - DKK - 0541
   NIP V - Calder - EUR - 030041
   NIP V - Calder - GBP - 3252
Table deals_positions, Col Deal Name: 24 matches
   Juniperhill Power, S. de R.L. de C.V. - USD
   NI ABF DevCo ApS
...
Table deals_positions, Col Position: 172 matches
   ESV Intermediate HoldCo LLC (Rhodolite (Funding Loan))
   ESV Intermediate HoldCo LLC - EUR (Rhodolite (Funding Loan)))
   Juniperhill Power, S. de R.L. de C.V. (Juniperhill (Funding Loan))
   Juniperhill Power, S. de R.L. de C.V. (La Gerda Solar (Equity))
   Juniperhill Power, S. de R.L. de C.V. (La Gerda Solar (Funding Loan))
...
Table investors, Col Investor: 14 matches
...
   NIP Global Energy Transition Aggregator - I
   ...
   NIP Holding 8 ApS
   Nethstead Liabilities Fund Limited
   Nordvik Infrastructure ABF I GP S.à r.l.
   Nordvik Infrastructure ABF II GP S.à r.l.
   Nordvik Infrastructure Advanced Bioenergy Fund I Feeder SCSp
   Nordvik Infrastructure Advanced Bioenergy Fund I GP S.à r.l.
Table legal_entities, Col Legal Entity: 9 matches
   Nordvik Infrastructure ABF II GP S.à r.l.
   Nordvik Infrastructure Advanced Bioenergy Fund I Feeder SCSp
   Nordvik Infrastructure Advanced Bioenergy Fund I GP S.à r.l.
   Nordvik Infrastructure Advanced Bioenergy Fund I SCSp
   Nordvik Infrastructure Advanced Bioenergy Fund I SCSp - Elim
   Nordvik Infrastructure Advanced Bioenergy Fund II Blocker SCSp
   Nordvik Infrastructure Advanced Bioenergy Fund II QFPF Blocker SCSp
   Nordvik Infrastructure Advanced Bioenergy Fund II QFPF SCSp
   Nordvik Infrastructure Advanced Bioenergy Fund II SCSp
Table project_codes, Col Project Code: 22 matches
   ABF II Fundraising
   BICKFORD ABF I
   Chrysolite
   Juniperhill
   ...
   OH – Credit Facility fee – Korea
   OH – Credit Facility fee – Non-US
   OH – Credit Facility fee – Taiwan
   OH – Credit Facility fee – US
   OHP - NIP2.0 IT
Table related_parties, Col Related Party: 31 matches
   Juniperhill Power, S. de R.L de C.V
   NI ABF DevCo Aps
...
Table vendors, Col Vendor: 7 matches
   Hanne hollmont Quargarth LIT - Non LU
   NI ABF I DevCo ApS
...
=== SEARCHING NIP LIT IN ALL TABLES ===
  deals_positions.Position: ESV Intermediate HoldCo LLC (Rhodolite (Funding Loan))
  deals_positions.Position: ESV Intermediate HoldCo LLC - EUR (Rhodolite (Funding Loan)))
  deals_positions.Position: NI GCF I Direct Lending US SCSp - ESV Intermediate HoldCo LLC (Rhodolite (Funding Loan))
  deals_positions.Position: NI GCF I Direct Lending US SCSp - ESV Intermediate HoldCo LLC - EUR (Rhodolite (Funding Loan))
  deals_positions.Position: NI GMF II Coöperatief U.A. - USD (AMPIN Energy Utility Pvt Ltd (HoldCo 1) (Pennyroyal II (Equity)))
  deals_positions.Position: NI GMF II Coöperatief U.A. - USD (AMPIN Energy Utility Pvt Ltd (HoldCo 1) (Pennyroyal II (Funding Loan)))
  deals_positions.Position: NI GMF II Coöperatief U.A. - USD (NI GMF II (Vietnam) Limited Liability Company (Squallmoor Kalvik) (Equity))
  deals_positions.Position: NI V Foxglove HoldCo LLC (Chrysolite (Funding Loan))
  deals_positions.Position: NI V Foxglove HoldCo LLC (Talitha Stenvik (Funding Loan))
  deals_positions.Position: NI V US A LP (NI V Foxglove HoldCo LLC (Chrysolite (Equity)))
  deals_positions.Position: NI V US A LP (NI V Foxglove HoldCo LLC (Talitha Stenvik (Equity)))
  deals_positions.Position: NI V US B LP ((NI V Foxglove HoldCo LLC (Chrysolite (Equity)))
  deals_positions.Position: NI V US B LP ((NI V Foxglove HoldCo LLC (Talitha Stenvik (Equity)))
  deals_positions.Position: NI V US C LP (NI V Foxglove QFPF LLC (Chrysolite (Equity)))
  deals_positions.Position: NI V US C LP (NI V Foxglove QFPF LLC (Talitha Stenvik (Equity)))
  deals_positions.Position: NI V US Non-QFPF EUR Blocker SCSp - USD (Chrysolite (Equity))
  deals_positions.Position: NI V US Non-QFPF EUR Blocker SCSp - USD (Chrysolite (Funding Loan))
  deals_positions.Position: NI V US Non-QFPF EUR Blocker SCSp - USD (Talitha Stenvik (Equity))
  deals_positions.Position: NI V US Non-QFPF EUR Block
...
- result_json: resolve.py did not produce a readable /work/result.json
    ame='NISC ApS - Non-LU' cls=Related Party
    Row 7: raw=None match=CANNOT_VERIFY name=None cls=Other
    Row 8: raw='RAQ MARBECK COMMUNICATIONS' match=MATCH name='RAQ Marbeck Communications - Non-LU' cls=Vendor
    Row 9: raw=None match=CANNOT_VERIFY name=None cls=Internal
