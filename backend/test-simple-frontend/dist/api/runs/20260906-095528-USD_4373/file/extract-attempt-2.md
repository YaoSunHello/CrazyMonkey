...
Your extract.py was REJECTED by the verifier. Attempt 2 of 8.

This is the extract.py you wrote, in full. **Edit it.** Keep every part that
...
- result_json: extract.py did not produce a readable /work/result.json
    Account: 240-644826-130, Currency: USD
    Printed closing balance: 943598.38
    Traceback (most recent call last):
      File "/work/extract.py", line 67, in <module>
...
Reply with the complete corrected extract.py in a single ```python code block.
