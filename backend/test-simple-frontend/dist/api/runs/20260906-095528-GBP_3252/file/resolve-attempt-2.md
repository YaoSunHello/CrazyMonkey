...
- result_json: resolve.py did not produce a readable /work/result.json
    charge or credit interest names no counterparty'}
    Result -> Project Raw: None
    Result -> Project Match: {'status': 'CANNOT_VERIFY', 'matched_name': None, 'table': None, 'confidence': None, 'why': 'Narrative names no project'}
