...
- result_json: journal.py did not produce a readable /work/result.json
    1/NORDVIK INFRASTRUCTURE PARTNER, S+P+ CHARGE WAIVED' dr=None cr=2100000.00 ccy=GBP acct=240-222731-132 class=Investor cp={'status': 'PROBABLE', 'matched_name': 'Nordvik Infrastructure V SCSp', 'table': 'legal_entities', 'confidence': 0.85, 'why': "Truncated narrative 'NORDVIK INFRASTRUCTURE PARTNER' corresponds to list entry 'Nordvik Infrastructure V SCSp'"}
    [15] narr='CREDIT INTEREST' dr=None cr=95.47 ccy=GBP acct=240-222731-132 class=Other cp={'status': 'CANNOT_VERIFY', 'matched_name': None, 'table': None, 'confidence': None, 'why': 'Bank commission charge or credit interest names no counterparty'}
    === END INSPECTION ===
