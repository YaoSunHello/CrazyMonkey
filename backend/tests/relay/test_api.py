...
def test_real_app_mounts_relay_and_serves_versioned_and_beacon_exports(
    ...
    assert client.get(f"/api/v1/reviews/{run_id}/exports/excel").status_code == 422
    excel = client.get(
        f"/api/v1/reviews/{run_id}/exports/excel", params={"version": version},
    )
    ...
    assert client.post(f"/api/v1/reviews/{run_id}/email/prepare").status_code == 422
    draft = client.post(
        f"/api/v1/reviews/{run_id}/email/prepare", params={"version": version},
    )
