...
const investorNames: Record<string, string> = {
  LP01: "Northbridge Pension",
  LP02: "Meridian Endowment",
  LP03: "Cedar Grove Foundation",
  LP04: "Harbour Family Office",
  LP05: "Sterling University",
  LP06: "Westgate Charitable Trust",
};
...
function createFinding(input: FindingInput): ReviewFinding {
  ...
  return {
    ...
    investorName: investorNames[input.investorId],
    ...
    status: input.status,
    severity: input.status === "CANNOT_VERIFY" ? "CRITICAL" : "NONE",
    confidence: {
      label: "NOT_SCORED",
      basis:
        "The Atlas review contract does not provide a confidence score; rely on the deterministic checks and linked source evidence.",
    },
