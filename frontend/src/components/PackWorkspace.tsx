      ...
      <div className="pack-layout">
        <aside className="pack-sidebar">
          <section className="pack-panel" aria-labelledby="pack-import-heading">
            ...
            {config && !config.configured && <p className="pack-notice">Configure the pack review service before starting a review. Saved runs remain available below.</p>}
            ...
            <p className="pack-muted pack-small">Selected files are sent only when you start the pack review.</p>
          </section>
        ...
        <section className="pack-results" aria-labelledby="pack-results-heading">
          ...
          {visibleRun && <>
            <p className="pack-run-id">Run <code>{visibleRun.run_id}</code> · pack review</p>
