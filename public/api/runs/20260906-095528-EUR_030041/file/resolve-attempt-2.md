...
Row 1:
  trn_type: TFR- | date: 31 Mar 2026
  debit: -0.44 | credit: None | bal: 1197694.98
  account_number: 240-222731-030
  narrative: 'CHARGES FOR 2, OUTWARD SEPA PAYMENT'

Row 2:
  trn_type: SCT | date: 31 Mar 2026
  debit: -74960.33 | credit: None | bal: 1197695.42
  account_number: 240-222731-030
  narrative: '22434343,63324540,54833311,11522044, NIP CINNABAR APS'

Row 3:
  trn_type: SCT | date: 31 Mar 2026
  debit: -8671.31 | credit: None | bal: 1272655.75
  account_number: 240-222731-030
  narrative: '35051052 / 412263620, ELLMONT AND CHALWORTH LUXEMBOURG SARL'

Row 4:
  trn_type: TFR- | date: 31 Mar 2026
  debit: -19526285.38 | credit: None | bal: 1281327.06
  account_number: 240-222731-030
  narrative: 'BQVRFRPP, /FR6239723540911169279904595 CHARGE WAIVED'

Row 5:
  trn_type: TFR- CHG | date: 31 Mar 2026
  debit: -6.00 | credit: None | bal: 20807612.44
  account_number: 240-222731-030
  narrative: 'COMMISSION EUR 6,00, 25515MS49ERZ'

Row 6:
  trn_type: TFR- | date: 31 Mar 2026
  debit: -9400000.00 | credit: None | bal: 20807618.44
  account_number: 240-222731-030
  narrative: 'NI RANFJORD II SCSP, 25515MS49ERZ, /DK9152066306262321 EQUITY: FROM NORDVIK INFRASTRUCTURE V SCSP EUR) TO NI RANFJORD II SCSP (EUR). PROJECT, RANFJORD II.'

Row 7:
  trn_type: TFR+ | date: 31 Mar 2026
  debit: None | credit: 29700000.00 | bal: 30207618.44
  account_number: 240-222731-030
  narrative: 'NORDVIK INFRASTRUCTURE V, TFR+ NORDVIK INFRASTRUCTURE V SCSP,ISIN XWDM430033AD,TRANCHE B1 CHARGE WAIVED'

Row 8:
  trn_type: TFR- | date: 31 Mar 2026
  debit: -535331.91 | credit: None | bal: 507618.44
  account_number: 240-222731-030
  narrative: 'BQVRFRPP, /FR6239723540911169279904595 CHARGE WAIVED'

Row 9:
  trn_type: TFR- | date: 27 Mar 2026
  debit: -2000000.00 | credit: None | bal: 1042950.35
  account_number: 240-222731-030
  narrative: 'BQVRFRPP, /FR6239723540911169279904595 CHARGE WAIVED'

Row 10:
  trn_type: TFR- | date: 25 Mar 2026
  debit: -2430836.90 | credit: None | bal: 3042950.35
  account_number: 240-222731-030
  narrative: 'BQVRFRPP, /FR6239723540911169279904595 CHARGE WAIVED'

Row 11:
  trn_type: TFR- | date: 24 Mar 2026
  debit: -0.22 | credit: None | bal: 5473787.25
  account_number: 240-222731-030
  narrative: 'CHARGES FOR 1, OUTWARD SEPA PAYMENT'

Row 12:
  trn_type: TFR+ | date: 24 Mar 2026
  debit: None | credit: 5001458.33 | bal: 5473787.47
  account_number: 240-222731-030
  narrative: '1/NORDVIK INFRASTRUCTURE PARTNER, TFR+ CHARGE WAIVED'

Row 13:
  trn_type: SCT | date: 24 Mar 2026
  debit: -407.00 | credit: None | bal: 472329.14
  account_number: 240-222731-030
  narrative: '00345435, GARRFIELD'

Row 14:
  trn_type: TFR- CHG | date: 24 Mar 2026
  debit: -6.00 | credit: None | bal: 472736.14
  account_number: 240-222731-030
  narrative: 'COMMISSION EUR 6,00, 72905UE80MRC'

Row 15:
  trn_type: TFR- | date: 24 Mar 2026
  debit: -20000.00 | credit: None | bal: 472742.14
  account_number: 240-222731-030
...
Row 16:
  trn_type: TFR- CHG | date: 24 Mar 2026
  debit: -6.00 | credit: None | bal: 492742.14
  account_number: 240-222731-030
  narrative: 'COMMISSION EUR 6,00, 67071UB44PDB'

Row 17:
  trn_type: TFR- | date: 24 Mar 2026
  debit: -20000.00 | credit: None | bal: 492748.14
  account_number: 240-222731-030
...
Row 18:
  trn_type: TFR+ INT | date: 24 Mar 2026
  debit: None | credit: 3937.30 | bal: 512748.14
  account_number: 240-222731-030
...
--- Row 1 ---
Narrative: CHARGES FOR 2, OUTWARD SEPA PAYMENT
  No counterparty exact lookup found via simple chunking.
...
--- Row 3 ---
Narrative: 35051052 / 412263620, ELLMONT AND CHALWORTH LUXEMBOURG SARL
  Counterparty lookups found: [('ELLMONT AND CHALWORTH LUXEMBOURG SARL', {'matched_name': 'Ellmont and Chalworth Luxembourg Sarl', 'table': 'vendors', 'column': 'Vendor', 'tried': ['ELLMONT AND CHALWORTH LUXEMBOURG SARL']})]
...
--- Row 6 ---
Narrative: NI RANFJORD II SCSP, 25515MS49ERZ, /DK9152066306262321 EQUITY: FROM NORDVIK INFRASTRUCTURE V SCSP EUR) TO NI RANFJORD II SCSP (EUR). PROJECT, RANFJORD II.
  Project word 'RANFJORD' -> {'matched_name': 'Ranfjord', 'table': 'project_codes', 'column': 'Project Code', 'tried': ['RANFJORD']}
  Project word 'RANFJORD' -> {'matched_name': 'Ranfjord', 'table': 'project_codes', 'column': 'Project Code', 'tried': ['RANFJORD']}
  Project word 'RANFJORD' -> {'matched_name': 'Ranfjord', 'table': 'project_codes', 'column': 'Project Code', 'tried': ['RANFJORD']}
  Counterparty lookups found: [('NI RANFJORD 
--- you ran explore-3.py and it printed ---
=== INSPECTION SCRIPT ===
Table account_map: ['Account Number', 'Bank Account']
Table deals_positions: ['Deal Name', 'Position']
Table investors: ['Investor']
Table legal_entities: ['Legal Entity']
Table project_codes: ['Project Code', 'New Project Code']
Table related_parties: ['Related Party']
Table vendors: ['Vendor']

--- Search for Cinnabar, Garrfield, Draconis, Ranfjord, BQVRFRPP, Nordvik ---

Keyword: Cinnabar

Keyword: Garrfield
  vendors.Vendor: ['Garrfield', 'Garrfield - Non-LU']

Keyword: Garfield

Keyword: Draconis
  related_parties.Related Party: ['NI DRACONIS HOLDCO I SCSp', 'NI DRACONIS HOLDCO II SCSp', 'NI DRACONIS HOLDCO III SCSp', 'NI IV Draconis I Holding ApS', 'NI IV Draconis II Holding ApS']
  deals_positions.Deal Name: ['NI Draconis HoldCo I SCSp', 'NI Draconis HoldCo II SCSp', 'NI IV Draconis I Holding ApS', 'NI IV Draconis II Holding ApS', 'NI IV Draconis III Holding ApS']
  deals_positions.Position: ['NI Draconis HoldCo I SCSp (Equity)', 'NI Draconis HoldCo II SCSp (Equity)', 'NI IV Draconis I Holding ApS (DK Tealford Isfjell (Equity))', 'NI IV Draconis II Holding ApS (DK Tealford Isfjell (Equity))', 'NI IV Draconis III Holding ApS (DK Tealford Isfjell (Equity))']

Keyword: Ranfjord
  related_parties.Related Party: ['NI Ranfjord II SCSp', 'NI Ranfjord SCSp']
  deals_positions.Deal Name: ['NI Ranfjord II SCSp - EUR', 'NI Ranfjord II SCSp - USD', 'NI Ranfjord SCSp', 'NI Ranfjord SCSp - EUR']
  deals_positions.Position: ['NI Ranfjord II SCSp - EUR ((NI Ranfjord II Ltd) (Ranfjord II)(Equity))', 'NI Ranfjord II SCSp - USD (Equity)', 'NI Ranfjord II SCSp - USD (NI Ranfjord II Ltd (Ranfjord II (Equity)))', 'NI Ranfjord II SCSp - USD (Ranfjord (Equity))', 'NI Ranfjord SCSP - EUR - NI Ranfjord Ltd (Ranfjord (Equity))']

Keyword: BQVRFRPP

Keyword: Nordvik
  legal_entities.Legal Entity: ['NORDVIK INFRASTRUCTURE GREEN CREDIT FUND I NON-SRT AIV SCSp - Eliminations', 'NORDVIK INFRASTRUCTURE GREEN CREDIT FUND I SCSp - Eliminations', 'Nordvik Infrastructure ABF II GP S.à r.l.', 'Nordvik Infrastructure Advanced Bioenergy Fund I Feeder SCSp', 'Nordvik Infrastructure Advanced Bioenergy Fund I GP S.à r.l.']
  related_parties.Related Party: ['Nordvik Infrastructure Advanced Bioenergy Fund I DK A K/S', 'Nordvik Infrastructure Advanced Bioenergy Fund I Feeder SCSp', 'Nordvik Infrastructure Advanced Bioenergy Fund II QFPF SCSp', 'Nordvik Infrastructure Advanced Bioenergy Fund II SCSp', 'Nordvik Infrastructure Co-invest GP S.A.RL (NIP)']
  vendors.Vendor: ['CE - Nordvik Economics - Non-LU', 'Nordvik Concierges Driven ApS- Non-LU', 'Nordvik Infrastructure Service Company ApS - Non-LU', 'Nordvik Infrastructure V GP ApS - Non LU', 'Nordvik Offshore Partners A/S - Non - LU']
  investors.Investor: ['Nordvik Infrastructure ABF I GP S.à r.l.', 'Nordvik Infrastructure ABF II GP S.à r.l.', 'Nordvik Infrastructure Advanced Bioenergy Fund I Feeder SCSp', 'Nordvik Infrastructure Advanced Bioenergy Fund I GP S.à r.l.', 'Nordvik Infrastructure Co-Invest GP S.à r.l.']
  deals_positions.Deal Name: ['Agatestone Grove I - Nordvik Infrastructure V US C LP', 'Agatestone Grove I - Nordvik Infrastructure V US D LP', 'Nordvik Infrastructure Advanced Bioenergy Fund I DK A K/S', 'Nordvik Infrastructure Advanced Bioenergy Fund I SCSp', 'Nordvik Infrastructure NMF IK/S']
  deals_positions.Position: ['Agatestone Grove I - Nordvik Infrastructure V US C LP (Equity)', 'NI GMF II Coöperatief U.A. (Nordvik Infrastructure NMF I K/S) (La Ullrvik (Equity))', 'Nordvik Infrastructure Advanced Bioenergy Fund I DK A K/S (Bindweed)', 'Nordvik Infrastructure Advanced Bioenergy Fund I SCSp (Ordinary Shares)', 'Nordvik Infrastructure NMF IK/S (NI NMF I Farnborough ProjectCo SpA (Equity))']

Keyword: FR62

Keyword: Chalworth
  vendors.Vendor: ['Ellmont & Chalworth - LU', 'Ellmont & Chalworth - Non-LU', 'Ellmont and Chalworth (USA) B.V. - Non-LU', 'Ellmont and Chalworth Luxembourg Sarl']
...
--- Search for Project Codes ---
  project_codes.Project Code: ['Ranfjord', 'Ranfjord II']
  project_codes.Project Code: ['DRACONIS V', 'Overheads (Draconis)']

--- Account Map ---
  Account 240-222731-030: Account Number
  Account 240-222731-030: Bank Account

--- Rows Detailed Analysis ---

Row 1: trn_type=TFR- debit=-0.44 credit=None
  narrative: CHARGES FOR 2, OUTWARD SEPA PAYMENT
  Found exact CP: []

Row 2: trn_type=SCT debit=-74960.33 credit=None
  narrative: 22434343,63324540,54833311,11522044, NIP CINNABAR APS
  Found exact CP: []
  Candidates for 'Cinnabar': []
  Candidates for 'NIP CINNABAR': [{'matched_name': 'NIP P/S', 'table': 'related_parties', 'column': 'Related Party', 'score': 0.355}, {'matched_name': 'NIP Inc. - Non-LU', 'table': 'vendors', 'column': 'Vendor', 'score': 0.355}, {'matched_name': 'NIP P/S', 'table': 'vendors', 'column': 'Vendor', 'score': 0.355}]

Row 3: trn_type=SCT debit=-8671.31 credit=None
  narrative: 35051052 / 412263620, ELLMONT AND CHALWORTH LUXEMBOURG SARL
  Found exact CP: [('ELLMONT AND CHALWORTH LUXEMBOURG SARL', {'matched_name': 'Ellmont and Chalworth Luxembourg Sarl', 'table': 'vendors', 'column': 'Vendor', 'tried': ['ELLMONT AND CHALWORTH LUXEMBOURG SARL']})]

Row 4: trn_type=TFR- debit=-19526285.38 credit=None
  narrative: BQVRFRPP, /FR6239723540911169279904595 CHARGE WAIVED
  Found exact CP: []
  Candidates for 'BQVRFRPP': []

Row 5: trn_type=TFR- CHG debit=-6.00 credit=None
  narrative: COMMISSION EUR 6,00, 25515MS49ERZ
  Found exact CP: []

Row 6: trn_type=TFR- debit=-9400000.00 credit=None
  narrative: NI RANFJORD II SCSP, 25515MS49ERZ, /DK9152066306262321 EQUITY: FROM NORDVIK INFRASTRUCTURE V SCSP EUR) TO NI RANFJORD II SCSP (EUR). PROJECT, RANFJORD II.
  Found exact CP: [('NI RANFJORD II SCSP (EUR)', {'matched_name': 'NI Ranfjord II SCSp - EUR', 'table': 'deals_positions', 'column': 'Deal Name', 'tried': ['NI RANFJORD II SCSP (EUR)']}), ('NI RANFJORD II SCSP', {'matched_name': 'NI Ranfjord II SCSp', 'table': 'related_parties', 'column': 'Related Party', 'tried'
...
- result_json: resolve.py did not produce a readable /work/result.json
    nvestment Transfer
    Row 16: CP=None -> CANNOT_VERIFY (None) | PRJ=None | CLS=Other
    Row 17: CP=NI DRACONIS HOLDCO II SCSP -> MATCH (NI Draconis HoldCo II SCSp) | PRJ=None | CLS=Investment Transfer
    Row 18: CP=None -> CANNOT_VERIFY (None) | PRJ=None | CLS=Other
