...
- posting: 0/20 lines name an account that exists
    row 0: '__INSPECTION__' is not in the chart of accounts
    row 0: '__INSPECTION__' is not in the chart of accounts
    row 1: '__INSPECTION__' is not in the chart of accounts
    row 1: '__INSPECTION__' is not in the chart of accounts
...
What your script printed when it ran:
    ...
    ositions: cannot unpack non-iterable Table object
      Candidate lookup error on legal_entities: cannot unpack non-iterable Table object
    
    Row 8 narrative: 'RAQ MARBECK COMMUNICATIONS, 44008EZ203K5, /DK0503692241454564 499'
      counterparty_match: {'status': 'MATCH', 'matched_name': 'RAQ Marbeck Communications - Non-LU', 'table': 'vendors', 'confidence': 1.0, 'why': 'Exact match in vendors list'}
      Candidate lookup error on account_map: cannot unpack non-iterable Table object
      Candidate lookup error on allocation_rules: cannot unpack non-iterable Table object
      Candidate lookup error on deals_positions: cannot unpack non-iterable Table object
      Candidate lookup error on legal_entities: cannot unpack non-iterable Table object
    
    Row 9 narrative: 'LU HBEU 240-149813-030, TFR+ INTERNAL FX TRANSFER TO COVER INVOICES, FX EUR 5000,00 AT 7,0193998 524830540'
      counterparty_match: {'status': 'CANNOT_VERIFY', 'matched_name': None, 'table': None, 'confidence': None, 'why': 'Internal transfer between own accounts names no counterparty'}
      Candidate lookup error on account_map: cannot unpack non-iterable Table object
      Candidate lookup error on allocation_rules: cannot unpack non-iterable Table object
      Candidate lookup error on deals_positions: cannot unpack non-iterable Table object
      Candidate lookup error on legal_entities: cannot unpack non-iterable Table object
    ...
    === TEST BATCHES_BALANCE ===
    batches_balance result: {'ok': True, 'batches': 1, 'balanced': 1, 'problems': []}
    inspected 10 rows
