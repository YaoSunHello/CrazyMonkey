...
=== ACCOUNT OWNER ===
Account map cols: ['Account Number', 'Bank Account']
...
Total RP: 296
  RP: NI GMF II Amazonite ProjectCo SpA
  RP: NI GMF II Basaltic HoldCo B.V.
  RP: NI GMF II Coöperatief U.A.
  RP: NI GMF II Dutch GP B.V.
  RP: NI GMF II Energy Chile Fondo de Ardvik
  RP: NI GMF II Feeder SCA SICAV-RAIF – Access Compartment
  RP: NI GMF II Feeder SCA SICAV-RAIF – NKP Compartment
  RP: NI GMF II Feeder SCSp
  RP: NI GMF II GP S.a.r.l
  RP: NI GMF II HedgeCo SCSp
  RP: NI GMF II La Dunlin ProjectCo SpA
  RP: NI GMF II MizarCo
  RP: NI GMF II SCSp
  RP: NI GMF II Skirnir ProjectCo SpA
  RP: NI GMF II Sponsor Investor K/S
  RP: NI IV Cooperatief U.A.
  RP: Nordvik Infrastructure Advanced Bioenergy Fund I DK A K/S
  RP: Nordvik Infrastructure Advanced Bioenergy Fund I Feeder SCSp
  RP: Nordvik Infrastructure Advanced Bioenergy Fund II QFPF SCSp
  RP: Nordvik Infrastructure Advanced Bioenergy Fund II SCSp
  RP: Nordvik Infrastructure Co-invest GP S.A.RL (NIP)
  RP: Nordvik Infrastructure Evergreen Credit Fund EUR SCSp
  RP: Nordvik Infrastructure Evergreen Non-US Blocker SCSp
  RP: Nordvik Infrastructure Evergreen US Blocker SCSp
  RP: Nordvik Infrastructure GCF I GP S.à r.l. (SGL)
  RP: Nordvik Infrastructure GCF II GP S.à r.l.
  RP: Nordvik Infrastructure Green Credit Fund I Non-SRT AIV SCSp (SGL)
  RP: Nordvik Infrastructure Green Credit Fund I SCSp (SGL)
  RP: Nordvik Infrastructure Green Credit Fund II EUR Non-US Blocker SCSp
  RP: Nordvik Infrastructure Green Credit Fund II EUR SCSp
  RP: Nordvik Infrastructure Green Credit Fund II EUR US Blocker SCSp
  RP: Nordvik Infrastructure Green Credit Fund II USD Blocked SCSp
  RP: Nordvik Infrastructure Green Credit Fund II USD Blocked SCSp (Do not use)
  RP: Nordvik Infrastructure Green Credit Fund II USD Non-US Blocker SCSp
  RP: Nordvik Infrastructure Green Credit Fund II USD SCSp
  RP: Nordvik Infrastructure Green Credit Fund II USD US Blocker SCSp
  RP: Nordvik Infrastructure Growth Markets Fund II Feeder SCA SICAV-RAIF
  RP: Nordvik Infrastructure I New Markets Fund I K/S
  RP: Nordvik Infrastructure IV GP S.à r.l.
  RP: Nordvik Infrastructure NMF I K/S
  RP: Nordvik Infrastructure Partners GP Interests Holding K/S
  RP: Nordvik Infrastructure Partners Inc. - Non LU
  RP: Nordvik Infrastructure SWIC Co-Invest Vehicle I SCSp
  RP: Nordvik Infrastructure V EUR Blocker Feeder SCSp
  RP: Nordvik Infrastructure V Feeder SCA SICAV-RAIF
  RP: Nordvik Infrastructure V Feeder SCA SICAV-RAIF B compartment
  RP: Nordvik Infrastructure V Feeder SCA SICAV-RAIF EUR compartment
  RP: Nordvik Infrastructure V GP ApS
  RP: Nordvik Infrastructure V GP I SCSp
  RP: Nordvik Infrastructure V GP S.à r.l
  RP: Nordvik Infrastructure V NO SCSp (Do not use)
  RP: Nordvik Infrastructure V SCSp
  RP: Nordvik Infrastructure V US A USD SCSp
  RP: Nordvik Infrastructure V US B USD SCSp
  RP: Nordvik Infrastructure V US C LP
  RP: Nordvik Infrastructure V US D LP
  RP: Nordvik Infrastructure V US GP A LLC
  RP: Nordvik Infrastructure V US Non-QFPF EUR Blocker SCSp
  RP: Nordvik Infrastructure V US Non-QFPF EUR SCSp
  RP: Nordvik Infrastructure V US Non-QFPF USD Feeder SCSp
  RP: Nordvik Infrastructure V US QFPF EUR SCSp
  RP: Nordvik Infrastructure V US QFPF USD Feeder SCSp
  RP: Nordvik Infrastructure V USD Blocker Feeder SCSp
  RP: Nordvik Infrastructure V USD Feeder SCSp
  RP: Nordvik Infrastructure VI GP Sarl
  RP: Nordvik Infrastructure VI SCSp
  RP: Nordvik infrastructure IV AUS Trust K/S
  RP: Nordvik infrastructure IV Dutch K/S
  RP: Nordvik infrastructure IV K/S
  RP: Nordvik infrastructure IV SCSp

=== LEGAL ENTITIES SAMPLE ===
Total LE: 97
  LE: Nordvik Infrastructure GMF II GP S.à r.l.
  LE: Nordvik Infrastructure Growth Markets Fund II CN SCSp
  LE: Nordvik Infrastructure Growth Markets Fund II Feeder SCA SICAV-RAIF
  LE: Nordvik Infrastructure Growth Markets Fund II Feeder SCA SICAV-RAIF – Access Compartment
  LE: Nordvik Infrastructure Growth Markets Fund II Feeder SCA SICAV-RAIF – NKP Compartment
  LE: Nordvik Infrastructure Growth Markets Fund II Feeder SCSp
  LE: Nordvik Infrastructure Growth Markets Fund II SCSp

=== PROJECT CODES SAMPLE ===
Project codes col Project Code: 586 items
  PC in Project Code: Atria
  PC in Project Code: Bragi
  PC in Project Code: DK OFW Re-tender (NI V)
  PC in Project Code: Elmwood
  PC in Project Code: Iapetus
  PC in Project Code: OFW-BE-1
  PC in Project Code: OFW-DK-6(DK TENDER)
  PC in Project Code: OFW-EE-2
  PC in Project Code: OFW-ES-1
  PC in Project Code: OFW-FI-1 (Greenfield)
  PC in Project Code: OFW-FR-2
  PC in Project Code: OFW-LT-1
  PC in Project Code: OFW-LV-1
  PC in Project Code: OFW-MT-1
  PC in Project Code: OFW-NO-1 (Scabious Nord)
  PC in Project Code: OFW-PL-1
  PC in Project Code: OFW-PT-1 (Jackdaw)
  PC in Project Code: OFW-SE-1 (Greenfield)
  PC in Project Code: OFW-XX-1 (New Market Screening NMF)
  PC in Project Code: Tansymoor
Project codes col New Project Code: 1 items

=== INVESTORS SAMPLE ===
Total Investors: 277
  Inv: KELMSTEAD Capital Partners S.A., SICAV-RAIF - Infrastructure Equity Stanthorpe
  Inv: LAF Central Value Bramford/Opportunistic Infrastructure Partnership LP
  Inv: Nordvik Infrastructure ABF I GP S.à r.l.
  Inv: Nordvik Infrastructure ABF II GP S.à r.l.
  Inv: Nordvik Infrastructure Advanced Bioenergy Fund I Feeder SCSp
  Inv: Nordvik Infrastructure Advanced Bioenergy Fund I GP S.à r.l.
  Inv: Nordvik Infrastructure Co-Invest GP S.à r.l.
  Inv: Nordvik Infrastructure Evergreen Credit Fund EUR SCSp
  Inv: Nordvik Infrastructure GCF I GP S.à r.l.
  Inv: Nordvik Infrastructure GCF II GP S.à r.l.
  Inv: Nor

Your resolve.py was REJECTED by the verifier. Attempt 3 of 10.
...
- result_json: resolve.py did not produce a readable /work/result.json
     pc_raw='IAPETUS'    pc_status=MATCH        class=Investment Transfer
    Row  9: type=S+P- CHG   cp_raw=None                             cp_status=CANNOT_VERIFY cp_name=None pc_raw=None         pc_status=CANNOT_VERIFY class=Other
    Row 10: type=S+P-       cp_raw='NI GMF II COOPERATIEF U.A'      cp_status=MATCH        cp_name='NI GMF II Coöperatief U.A.' pc_raw='BRAGI'      pc_status=MATCH        class=Investment Transfer
    Row 11: type=S+P-       cp_raw='BQVRFRPP'                       cp_status=UNRESOLVED   cp_name=None pc_raw=None         pc_status=CANNOT_VERIFY class=Internal
