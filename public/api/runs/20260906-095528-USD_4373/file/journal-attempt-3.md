...
- result_json: journal.py did not produce a readable /work/result.json
    ERNAL TRANSFER', 'credit': None, 'debit': '-85000.00', 'balance': '1168551.86', 'account_number': '240-644826-130', 'currency': 'USD', 'page': 1, 'counterparty_raw': 'NI GMF II SCSP', 'counterparty_match': {'status': 'MATCH', 'matched_name': 'NI GMF II SCSp', 'table': 'related_parties', 'confidence': 1.0, 'why': 'Matched in related_parties'}, 'project_code_raw': None, 'project_code_match': {'status': 'CANNOT_VERIFY', 'matched_name': None, 'table': None, 'confidence': None, 'why': None}, 'classification': 'Internal'}
    Questions: []
    Traceback (most recent call last):
      File "/work/journal.py", line 36, in <module>
